    ...
    SilicaFlickable {
        ...
        Column {
            ...
            Label {
                x: Theme.horizontalPageMargin
                width: parent.width - 2 * Theme.horizontalPageMargin
                text: qsTr("SailVideo is a native Sailfish OS media player focused on local videos and home-network media. It uses the Sailfish QtMultimedia/GStreamer playback stack and provides a Sailfish-style interface for local files, SMB/NAS shares and HTTP/HTTPS video sources.")
                color: Theme.secondaryColor
                wrapMode: Text.Wrap
            }
