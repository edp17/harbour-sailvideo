...
Page {
    ...
    SilicaFlickable {
        ...
        Column {
            ...
            SectionHeader {
                visible: appWindow.castMode || appSettings.hasDetachedCastSession
                text: appWindow.castMode ? qsTr("Now casting") : qsTr("Chromecast")
            }
                        ...
                        Label {
                            ...
                            text: appWindow.castActivePicture
                                  ...
                                  : (appWindow.currentMediaTitle.length > 0
                                     ...
                                     : qsTr("Cast session"))
                            color: castingCard.highlighted ? Theme.highlightColor : Theme.primaryColor
                        ...
                        Label {
                            ...
                            text: appWindow.castMode
                                  ...
                                  : qsTr("Last Cast session on %1 · tap to reconnect")
                                        .arg(appSettings.detachedCastDeviceName.length > 0
                                             ? appSettings.detachedCastDeviceName
                                             : qsTr("Chromecast"))
