...
Page {
    ...
    function seekBack() {
        appWindow.requestSeek(Math.max(0, appWindow.player.position - appWindow.skipMilliseconds()))
        controlsHideTimer.restart()
    }

    function seekForward() {
        if (appWindow.player.duration > 0) {
            appWindow.requestSeek(Math.min(appWindow.player.duration,
                                           appWindow.player.position + appWindow.skipMilliseconds()))
        }
        controlsHideTimer.restart()
    }
    ...
    Rectangle {
        ...
        Column {
            ...
            Item {
                ...
                Row {
                    ...
                    IconButton {
                        ...
                        enabled: appWindow.hasPreviousVideo
                        opacity: enabled ? 1.0 : 0.35
                        icon.source: "image://theme/icon-m-previous"

                        onClicked: {
                            appWindow.playPreviousVideo()
                            controlsHideTimer.restart()
                        }
                    }
                    ...
                    IconButton {
                        ...
                        icon.source: appWindow.player.playbackState === MediaPlayer.PlayingState
                    ...
                    IconButton {
                        ...
                        enabled: appWindow.hasNextVideo
                        opacity: enabled ? 1.0 : 0.35
            ...
            Label {
                width: parent.width
                text: qsTr("Left swipe: video brightness · Right swipe: media volume · Scaling: %1")
            ...
            Item {
                ...
                Rectangle {
                    ...
                    Rectangle {
                        width: appWindow.player.duration > 0
                               ? parent.width * appWindow.player.position
                                 / appWindow.player.duration
                               : 0
                    ...
                    MouseArea {
                        ...
                        function seekToPointer(mouseX) {
                            ...
                            var target = Math.round(
                                appWindow.player.duration * boundedX / width)
            ...
            Item {
                ...
                Label {
                    ...
                    text: appWindow.formatTime(appWindow.player.position)
                    color: "white"
                    font.pixelSize: Theme.fontSizeExtraSmall
                }
                ...
                Label {
                    anchors.centerIn: parent
                    visible: appWindow.pendingResumeSeek || appWindow.userSeekPending
                ...
                Label {
                    ...
                    text: appWindow.formatTime(appWindow.player.duration)
                    color: "white"
                    font.pixelSize: Theme.fontSizeExtraSmall
                }
            }
